...
\todo{Explain why it exists, what it attempts to solve and architecture, mention rewards}

\subsection{Participants Selection Mechanism}
...
\subsection{Scoring and Aggregation Mechanism}
...
\todo{Explain local differential privacy}
