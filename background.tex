As mentioned in \Cref{chapter:introduction} and \Cref{chapter:related_work}, this thesis focuses on comparing different algorithms of Blockchain-based Federated Learning (BFS). This chapter gives an overview of the fundamental concepts and the selected algorithms that will be compared.
