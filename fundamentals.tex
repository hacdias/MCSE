...
\todo{Revisit this subsection. Maybe the motivation from FL can be shortly embedded into the introduction instead of here and leave this just for the concepts.}
...
\todo{Characteristics can stay but make them shorter.}
...
\todo{Don't make this a sub-section and say there are three types, but we focus on horizontal. Proceed to explain horizontal.}
